...
type SwitchRef = React.ElementRef<typeof SwitchRx.Root>;
type SwitchProps = React.ComponentPropsWithoutRef<typeof SwitchRx.Root>;
...
Switch.displayName = SwitchRx.Root.displayName
